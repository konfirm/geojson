...
export const shapes: Array<{ a: GeoJSON, b: GeoJSON, direct: number, haversine: number, vincenty: number }> = [
    ...
    { a: { type: 'Point', coordinates: [1, 1] }, b: { type: 'LineString', coordinates: [[0, 2], [2, 2]] }, direct: 111195.07973436874, haversine: 111195.07973436874, vincenty: 110575.0648144927 },
    ...
    { a: { type: 'Point', coordinates: [0, 1] }, b: { type: 'LineString', coordinates: [[0, 0], [2, 2]] }, direct: 78626.794914751, haversine: 78623.30209761004, vincenty: 78448.32051830029 },
    { a: { type: 'Point', coordinates: [1, 0] }, b: { type: 'LineString', coordinates: [[0, 0], [2, 2]] }, direct: 78626.794914751, haversine: 78626.29592703035, vincenty: 78451.24803121672 },

    { a: { type: 'MultiPoint', coordinates: [[9, 9], [1, 0]] }, b: { type: 'LineString', coordinates: [[0, 0], [2, 2]] }, direct: 78626.794914751, haversine: 78626.29592703035, vincenty: 78451.24803121672 },
    { a: { type: 'Point', coordinates: [1, 0] }, b: { type: 'MultiLineString', coordinates: [[[100, 100], [200, 200]], [[0, 0], [2, 2]]] }, direct: 78626.794914751, haversine: 78626.29592703035, vincenty: 78451.24803121672 },
    { a: { type: 'MultiPoint', coordinates: [[9, 9], [1, 0]] }, b: { type: 'MultiLineString', coordinates: [[[100, 100], [200, 200]], [[0, 0], [2, 2]]] }, direct: 78626.794914751, haversine: 78626.29592703035, vincenty: 78451.24803121672 },

    { a: { type: 'Point', coordinates: [2, 2] }, b: { type: 'Polygon', coordinates: [[[0, 0], [0, 4], [4, 4], [4, 0], [0, 0]]] }, direct: 0, haversine: 0, vincenty: 0 },
    { a: { type: 'Point', coordinates: [5, 2] }, b: { type: 'Polygon', coordinates: [[[0, 0], [0, 4], [4, 4], [4, 0], [0, 0]]] }, direct: 111195.07973436874, haversine: 111127.34097821356, vincenty: 111252.1298001606 },
    { a: { type: 'Point', coordinates: [2, 2] }, b: { type: 'Polygon', coordinates: [[[0, 0], [0, 4], [4, 4], [4, 0], [0, 0]], [[1, 1], [3, 1], [3, 3], [1, 3], [1, 1]]] }, direct: 111195.07973436874, haversine: 111127.34097821356, vincenty: 110575.0648144927 },
    ...
    { a: { type: 'LineString', coordinates: [[0, 0], [2, 0]] }, b: { type: 'LineString', coordinates: [[3, 2], [3, 0]] }, direct: 111195.07973436874, haversine: 111195.07973436874, vincenty: 111319.49079322325 },
    ...
    { a: { type: 'LineString', coordinates: [[3, 3], [4, 3]] }, b: poly, direct: 111195.07973436874, haversine: 111042.6868815999, vincenty: 110576.41652430623 },
    { a: { type: 'LineString', coordinates: [[7.5, 3], [8.5, 3]] }, b: poly, direct: 55597.53986718437, haversine: 55521.344888509884, vincenty: 55583.97477025065 },
    { a: { type: 'LineString', coordinates: [[3, 6], [3, 9]] }, b: poly, direct: 111195.07973436874, haversine: 110366.22766612672, vincenty: 110495.20453687457 },
    ...
    { a: { type: 'Polygon', coordinates: [[[0, 0], [0, 9], [9, 9], [9, 0], [0, 0]], [[1, 1], [8, 1], [8, 8], [1, 8], [1, 1]]] }, b: { type: 'Polygon', coordinates: [[[2, 2], [2, 7], [7, 7], [7, 2], [2, 2]]] }, direct: 111195.07973436874, haversine: 110366.22766612672, vincenty: 110495.20453687457 },
